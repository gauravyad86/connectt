		...
		<ScrollView contentContainerStyle={styles.scrollContainer} vertical>
			...
			<View style={styles.btncontainer}>
				<TouchableOpacity
					...
					onPress={() => {
						navigation.navigate('PprofileScreen', {
							currentData: displayedUser,
						});
					}}
				>
				...
				<TouchableOpacity
					...
					onPress={() => {
						navigation.navigate('PrefrenceScreen', {
							currentData: displayedUser,
						});
					}}
				>
			...
			{isExpanded && <HomeViewMore currentData={displayedUser} hide={true} />}

			<Text style={styles.buttonText}>Preference</Text>

			{isExpanded && <HomeViewMore2 currentData={displayedUser} />}
		</ScrollView>
	);
}
