...
import DiscoverySettings2 from '@/components/screens/DiscoverySettings2';
import PrefrenceScreen from '@/components/screens/PrefrenceScreen';
import PprofileScreen from '@/components/screens/PprofileScreen';
import Relatives from '@/components/screens/Relatives';
				...
				<>
					<Stack.Group>
						...
						<Stack.Screen
							...
							component={PrefrenceScreen}
							options={{ ...TransitionPresets.SlideFromRightIOS }}
						/>
						<Stack.Screen
							name='PprofileScreen'
							component={PprofileScreen}
							options={{ ...TransitionPresets.SlideFromRightIOS }}
						/>
						<Stack.Screen
							name='purchase'
						...
						/>
						<Stack.Screen
							name='redsubscription'
							component={RedSubscriptionPlanpage}
							options={{ ...TransitionPresets.SlideFromRightIOS }}
						/>
						<Stack.Screen
							name='addcarddetails'
						...
						<Stack.Screen
							name='picks'
							component={Chat_Picks_click}
							options={{ ...TransitionPresets.SlideFromRightIOS }}
						/>
						<Stack.Screen
							name='substartclick'
							component={MysubStarting}
							options={{ ...TransitionPresets.SlideFromRightIOS }}
						/>
						<Stack.Screen
							name='seewholikeyoumore'
							component={SeeWhoLikeYou}
							options={{ ...TransitionPresets.SlideFromRightIOS }}
						/>
						<Stack.Screen
							name='notifications'
						...
						/>
						<Stack.Screen
							name='lookingforwomen'
							component={Women}
							options={{ ...TransitionPresets.SlideFromRightIOS }}
						/>
						<Stack.Screen
							name='bank'
							component={AddBanking}
							options={{ ...TransitionPresets.SlideFromRightIOS }}
						/>
						<Stack.Screen
							name='gridbox'
						...
						/>
						<Stack.Screen
							name='homepagestarselect'
							component={HompagestarSelect}
							options={{ ...TransitionPresets.SlideFromRightIOS }}
						/>
						<Stack.Screen
							name='boostselect'
							component={BoostSelect}
							options={{ ...TransitionPresets.SlideFromRightIOS }}
						/>
						<Stack.Screen
							name='setting'
						...
						<Stack.Screen
							name='Interests2'
							component={InterestsPage2}
							options={{ ...TransitionPresets.SlideFromRightIOS }}
						/>
						<Stack.Screen
							name='Interests3'
							component={InterestsPage3}
							options={{ ...TransitionPresets.SlideFromRightIOS }}
						/>
						<Stack.Screen
							name='Interests4'
							component={InterestsPage4}
							options={{ ...TransitionPresets.SlideFromRightIOS }}
						/>
						<Stack.Screen
							name='platinumsub'
							component={PlatinumSubscription}
							options={{ ...TransitionPresets.SlideFromRightIOS }}
						/>
					</Stack.Group>
				</>
