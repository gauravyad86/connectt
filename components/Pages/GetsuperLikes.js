...
//                             <Fontisto name="connect" size={ 22 } color="yellow" style={ styles.icon } />
			...
			>
				...
				<View style={styles.bottombox}>
					<Text style={styles.bottomText}>
						Includes 5 free Super Likes per week
					</Text>
					<View style={styles.header2}>
						<View
							style={{
						...
						>
							{/* <Fontisto name="connect" size={22} color={bgColor} style={styles.icon} /> */}
							<Text style={styles.tinderGoldText}>Get Connect Gold</Text>
						</View>
						<TouchableOpacity
							style={styles.goldSelectButton}
							onPress={() => {
								navigation.navigate('seewholikeyoumore');
							}}
						>
