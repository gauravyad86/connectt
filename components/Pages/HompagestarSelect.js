			...
			>
				<View style={styles.container}>
					...
					<View style={styles.purchaseDetails}>
						...
						>
							<View style={styles.tindericonBackground}>
								<Fontisto size={18} name='connect' color={lightColor} />
							</View>
					...
					<Text style={styles.description}>
						Add a payment method to your Google Account to complete your
						purchase. Your payment information is only visible to Google
					</Text>
					{/* Payment Options */}
					<View style={styles.paymentOptions}>
						<TouchableOpacity
							style={[styles.paymentButton, { flexDirection: 'row' }]}
						>
							<FontAwesome6 name='amazon-pay' size={24} color={lightColor} />
							<Text style={{ color: lightColor, marginLeft: 10 }}>
								Pay with UPI
							</Text>
						</TouchableOpacity>
						<TouchableOpacity
