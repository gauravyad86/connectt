	...
	return (
		<ScrollView style={styles.container}>
			...
			<TextInput
				style={[
					styles.input,
					{ backgroundColor: lightTheme, color: lightColor },
				]}
			...
			<Text style={{ color: lightColor }}>
				By continuing, you create a Google Payments account and agree to the
			...
			<View style={styles.purchaseDetails}>
				...
				>
					<View style={styles.tindericonBackground}>
						<Fontisto size={21} name='connect' color={lightColor} />
					</View>
