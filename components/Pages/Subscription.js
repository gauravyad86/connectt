...
//                         <Fontisto size={ 25 } name='connect' color="#ecb757" style={ { marginRight: 8 } } />
//                         <Text style={ styles.optionTitle }>Connect</Text>
//                         <Text style={ styles.planLabelGOLD }>GOLD</Text>
//                     </TouchableOpacity>
//                     <TouchableOpacity style={ styles.box1 }>
//                         <Fontisto name="connect" size={ 25 } color="#FD297B" />
//                         <Text style={ styles.optionTitle }> Connect</Text>
//                         <AntDesign name="plus" size={ 20 } color="#FD297B" />
//                     </TouchableOpacity>

//                     <TouchableOpacity style={ styles.box3 }>
//                         <Fontisto size={ 25 } name='connect' color="#252523" style={ { marginRight: 7 } } />
//                         <Text style={ styles.optionTitle }>Connect</Text>
	...
	return (
		<View style={styles.pageWrapper}>
			...
			>
				...
				<View style={styles.topBar}>
					<Text style={[styles.pageTitle, { color: lightColor }]}>
						My Subscription
					</Text>
				</View>
				...
				{[
					...
					<View key={index} style={styles.upgradeContainer}>
						...
						<View style={styles.upgradeSection}>{renderBenefits(title)}</View>
					</View>
				))}
			</ScrollView>
	...
	const benefits = {
		'Upgrade Your Likes': [
			...
			{ label: 'See Who Likes You', unlocked: false },
			{
				...
				unlocked: false,
				description: 'Your Likes will be seen sooner',
			},
		],
		'Enhance your experience': [
			{ label: 'Unlimited Rewinds', unlocked: true },
			...
			{ label: '3 Free Super Likes per week', unlocked: false },
			{
				label: 'Message Before Matching',
				unlocked: false,
				description: 'Add a note to your Super Likes',
			},
		],
		'Premium Discovery': [
			{
			...
			},
			{
				label: 'Top Picks',
				unlocked: false,
				description: 'Browse through a daily curated selection of profiles',
			},
		],
		'Take Control': [
			{
				...
				unlocked: true,
				description: 'Only show what you want them to show',
			},
			{
	...
	return benefits[title].map((item, index) => (
		<View key={index} style={styles.benefitItem}>
			...
			<View>
				<Text style={styles.benefitLabel}>{item.label}</Text>
				{item.description && (
					<Text style={styles.benefitLabel2}>{item.description}</Text>
				)}
			</View>
		</View>
	));
