  ...
  return (
    <ScrollView style={styles.container}>
      <TouchableOpacity style={styles.header} onPress={navigation.goBack()}>
         <View style={styles.header}> <Ionicons name="arrow-back" size={24} color="red" /><Text style={{color:"white", marginLeft:5}}>Settings</Text></View>
       </TouchableOpacity>
      <View style={styles.subscriptionSection}>
        ...
        <TouchableOpacity style={styles.subscriptionOption}>
          ...
          <Fontisto name="tinder"  size={15} color="gold" style={styles.icon} />  <Text style={styles.optionTitle}>tinder Gold</Text>
          </View>
