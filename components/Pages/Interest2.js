    ...
    return (
        <View style={ styles.mainContainer }>
            ...
            <TouchableOpacity
                ...
                onPress={ () => navigation.navigate( 'Interests2', { setSelectedInterests, selectedInterests } ) }  // Pass the setter function and current interests
            >
                <TextInput
...
const InterestsPage2 = ( { route, navigation } ) => {
...
export default InterestsInput2;
export { InterestsPage2 };